...
Di seguito sono elencate le funzioni sviluppate nel file lib.h [dichiarazioni/prototipi] e lib.c [definizione]:

- [x] void initVettore(int _vet[], int _dim); Init an array with random values between 1 an 10
- [x] void stampaVettore(int _vet[], int _dim); Print an array of integer values
